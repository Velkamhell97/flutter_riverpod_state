...
class _$_NoError with DiagnosticableTreeMixin implements _NoError {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties..add(DiagnosticsProperty('type', 'CreateProfileState.noError'));
  }
...
class _$_Error with DiagnosticableTreeMixin implements _Error {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'CreateProfileState.error'))
...
class _$_Loading with DiagnosticableTreeMixin implements _Loading {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'CreateProfileState.loading'));
  }
